...
// 만약, 개발자가 20개의 원을 만든다면, 우리는 arc함수를 20번 사용해야함
// 그리고 그때마다 우리는 너비, 높이, 반지름, 색상을 매범 기입해야함
...
function Circle(x, y, radius, color) {
  ...
  this.draw = function () {
    ...
    ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 360, false);
    ctx.fill();
  };
...
// x중심축, y중심축, 반지름, 컬러 => 4개 값(1쌍)이 랜덤으로 필요함
// 총 20개가 필요함
// 20개를 반복문으로 만들었다고 가정
// 1쌍 2쌍 3쌍 ....20쌍
...
// 현재 20쌍의 값이 iterable한 객체안에 담겨있어야, 각각의 아이템을 가져와서 draw()에 적용할 수 있음
