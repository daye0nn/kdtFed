...
이러한 객체 지향언어들은 거의 대부분 this객체를 가지고 있음 => 어떤 함수 혹은 속성값이 실행되었을 때, 실행된 함수 및 속성의 주인이 누구인지를 효율적으로 가리켜서 쉽게 찾아올 수 있게 해주는 역할
...
// 3. 특정 객체 안에 있는 속성 중 메서드를 활용해서 this 요청 => 해당 객체
