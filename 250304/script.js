...
// GET 방식으로 요청을 했습니다!!
// POST 방식 => 사용자가 클라이언트를 통해서 어떤 값을 전달하고, 전달받은 해당 값을 기반으로 서버에서 업데이트 된 정보를 다시 사용자에게 전달하는 방식
...
console.log(json);
// 클라이언트 & 서버가 서로 통신을 하는데, json데이터 자료를 주고, 받는다!! => 해당 자료를 아무런 변환작업없이 그대로 사용 불가능
